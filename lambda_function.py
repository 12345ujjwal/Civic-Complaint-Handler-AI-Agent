...
QUESTION_FOR_FIELD = {
    ...
    "location": "Could you share the location or a nearby landmark? You can also tap 📍 to share your live location.",
    "condition": "Could you briefly describe how serious this is or how it's affecting people nearby?"
}

SLACK_WEBHOOK_URL = "https://hooks.slack.com/<YOUR URL>"
...
- location: an area, street, or landmark if mentioned in this message, else null
